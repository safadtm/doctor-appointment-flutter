...
class OppoinmentScreen extends StatefulWidget {
  int index=0;
  OppoinmentScreen(this.index, {super.key});
  @override
  State<OppoinmentScreen> createState() => _OppoinmentScreenState();
}

class _OppoinmentScreenState extends State<OppoinmentScreen> {
  var images=[
